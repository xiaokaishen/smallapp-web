<template>
  <div class="app-container">
    ...
    <table class="basic-information">
      ...
      <tr>
        <td>活动规模</td>
        <td>{{adoptDetail.activityScale == null?0:adoptDetail.activityScale}}</td>
        <td>活动最大参与人数</td>
        <td>{{adoptDetail.activityMaxNumber == null?0:adoptDetail.activityMaxNumber}}</td>
      </tr>
      <tr>
        <td>活动已参与人数</td>
      ...
      <tr>
        <td>艺术家图片</td>
        <td colspan="3"><img :src="adoptDetail.acitvityImg"></td>
      </tr>
<!--      <tr>
        <td>艺术家说</td>
...
<script>
  import {getDetailById,queryActivity} from '@/api/customArtwork'
